...
public interface AgentMapper {
	...
	@Insert("""
			INSERT INTO agent (name, description, avatar, status, api_key, api_key_enabled, prompt, category, admin_id, workspace_id, tags, create_time, update_time)
			VALUES (#{name}, #{description}, #{avatar}, #{status}, #{apiKey}, #{apiKeyEnabled}, #{prompt}, #{category}, #{adminId}, #{workspaceId}, #{tags}, #{createTime}, #{updateTime})
			""")
