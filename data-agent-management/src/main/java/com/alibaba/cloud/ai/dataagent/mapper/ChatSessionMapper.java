...
public interface ChatSessionMapper {
	...
	/**
	 * Query session list by agent ID, optionally scoped to a single user
	 */
	@Select("""
			<script>
	...
	/**
	 * Soft delete all sessions for an agent, optionally scoped to a single user
	 */
	@Update("""
			<script>
			UPDATE chat_session
			...
			""")
	int softDeleteByAgentId(@Param("agentId") Integer agentId, @Param("userId") Long userId,
